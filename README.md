...
| <a name="input_subnets"></a> [subnets](#input\_subnets) | Subnet information for tagging purposes and newbits to pass to cidr\_subnets function | <pre>list(object({<br>    name     = string<br>    new_bits = number<br>  }))</pre> | n/a | yes |
